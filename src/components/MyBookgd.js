  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <HTMLFlipBook
        ...
        <Page number={1} image={process.env.PUBLIC_URL + "/assets/book/white.png"} />
        <Page number={2} image={process.env.PUBLIC_URL + "/assets/book/spis.png"} />
        ...
        <Page number={22} image={process.env.PUBLIC_URL + "/assets/book/21.png"} />
        <Page number={23} image={process.env.PUBLIC_URL + "/assets/book/22.png"} />
        <Page number={24} image={process.env.PUBLIC_URL + "/assets/book/23.png"} />
